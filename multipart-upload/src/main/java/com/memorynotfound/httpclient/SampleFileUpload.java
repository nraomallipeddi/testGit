...
public class SampleFileUpload {
    ...
    public static void main(String args[]){
        ...
        File file = new File ("C://Users/kpkumar/Desktop/sample.txt") ;

        String response = fileUpload.executeMultiPartRequest("http://10.210.242.53:19000/api/sample", file, file.getName(), "File Upload test Hydrangeas.jpg description") ;
